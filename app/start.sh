...
echo "chromium-browser --start-fullscreen --window-size=1920,1080  $URL_LAUNCHER_URL --disable-gpu --headless --disable-software-rasterizer --disable-dev-shm-usage" >> /home/chromium/xstart.sh
